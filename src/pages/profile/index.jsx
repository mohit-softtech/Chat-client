    ...
    if (validateProfile()) {
      try {
        ...
        if (response.status >= 200 && response.status < 300 && response.data) {
          ...
          // Handle unexpected response status or missing data
          ...
          >
            ...
            {hovered && (
              <div
                ...
                onClick={image ? handleDeleteImage : handleFileInputClck}
              >
                {image ? (
